...
var _default = tippy;
exports.default = _default;
},{"@popperjs/core":"../../node_modules/@popperjs/core/lib/popper.js"}],"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../../node_modules/tippy.js/animations/scale.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
window.addEventListener("load", function () {
  if (localStorage.getItem("todos")) renderTodos(JSON.parse(localStorage.getItem("todos")));else renderTodos(TODO_LIST);
}); //Grab DOM elements

var todoInputEl = document.querySelector(".todo-input");
var addTodoBtnEl = document.querySelector(".add-todo");
var todoContentEl = document.querySelector(".todo-box");
var alertToastEl = document.querySelector(".alert-toast");
var danielTooltipSpan = document.querySelector("#daniel-tooltip");
(0, _tippy.default)(danielTooltipSpan, {
...
todoInputEl.addEventListener("input", function (e) {
  todo = e.target.value;
});
...
window.deleteTodo = function (todoId) {
  var filteredTodo = parsedTodos.findIndex(function (todo) {
...
window.doneTodo = function (todoId) {
  var todo = parsedTodos.find(function (todo) {
    return todo.id === todoId;
  });
  if (!todo.done) todo.done = true;else todo.done = false;
  localStorage.setItem("todos", JSON.stringify(parsedTodos));
  renderTodos(parsedTodos);
};
...
function renderTodos(todos) {
  if (Object.keys(todos).length === 0) {
    ...
    todoContentEl.innerHTML = todos.map(function (todo) {
      return "<div class=\" flex justify-between w-full bg-teal-100 hover:bg-green-100 hover:shadow-md shadow-sm pl-1 pr-1 mb-3\">\n        <div class=\"mb-3 mt-2 todo-text flex ".concat(todo.done ? "line-through" : "", "\"> <div class=\"mr-2\">").concat(todo.date, " - </div>").concat(todo.text, "</div>\n        <div class=\"bg-yellow-300 w-12 h-6 flex self-center justify-around shadow-sm\">\n        \n          <button id='delete-todo' onclick=\"deleteTodo('").concat(todo.id, "')\" class=\"flex justify-center self-center delete-todo\">\n          \n          <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"15\" height=\"18\" viewBox=\"0 0 24 24\"><path d=\"M24 20.188l-8.315-8.209 8.2-8.282-3.697-3.697-8.212 8.318-8.31-8.203-3.666 3.666 8.321 8.24-8.206 8.313 3.666 3.666 8.237-8.318 8.285 8.203z\"/></svg>\n        \n          </button>\n\n          <button onclick=\"doneTodo('").concat(todo.id, "')\">\n       \n            <svg\n              xmlns=\"http://www.w3.org/2000/svg\"\n              width=\"17\"\n              height=\"18\"\n              viewBox=\"0 0 24 24\"\n            >\n              <path d=\"M20.285 2l-11.285 11.567-5.286-5.011-3.714 3.716 9 8.728 15-15.285z\" />\n            </svg>\n          \n          </button>\n        </div>\n      </div>\n      ");
    }).join("");
  }
}
},{"tippy.js":"../../node_modules/tippy.js/dist/tippy.esm.js","tippy.js/animations/scale.css":"../../node_modules/tippy.js/animations/scale.css"}],"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1908" + '/');
...
},{}]},{},["C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
