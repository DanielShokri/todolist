...
function renderTodo(todo) {
  ...
  var item = document.querySelector("[data-key='".concat(todo.id, "']"));
...
list.addEventListener("click", function (event) {
  ...
  if (event.target.classList.contains("js-delete-todo")) {
    var _itemKey = event.target.parentElement.dataset.key;
    deleteTodo(_itemKey);
  }
});
...
},{}],"C:/Users/דניאל שוקרי/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
